...
- Why the hand-written recursive `my-reduce` blows the stack: **Clojure has no TCO**, because the JVM has none.
  The book mentions this only in the day-1 self-study.
